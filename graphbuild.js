...
var g_specName = "graphspec_stacked.json";
...
function deleteGraph() {
    try {
        ...
        vis.data("table").remove(function(d) {return true})
...
d3.select("#resetData").on("click", loadSpec)
